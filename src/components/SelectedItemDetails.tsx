...
function SelectedItemDetails({ isDriver }: { isDriver?: boolean | undefined }) {
  return (
    <div className="flex flex-col justify-start items-start w-full px-3 gap-2">
      <h3 className="flex items-center gap-2 p-1.5 text-sm font-medium text-slate-200 capitalize tracking-wide bg-orange-500 dark:bg-orange-600 rounded-sm w-full">
